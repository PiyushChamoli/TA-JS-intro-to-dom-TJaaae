...
let filterallHrsArray = allHrsArray.filter(hr => hr.className = 'image');
filterallHrsArray.map(hr => hr.style.border = '2px solid purple');
// Hide the box number 17 (last box).

// Change the border of all the hr element from solid to dashed type
allHrsArray.map(hr => hr.style.borderStyle = 'dashed');
