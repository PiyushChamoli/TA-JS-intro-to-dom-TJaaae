...
para.innerText = 'querySelector returns an element you can manupulate but querySelectorAll returns the collection of elements in array kind of structure.';
...
let box2text = document.createTextNode('Append inserts as last child');
box2p.append(box2text);
box2.append(box2p);
...
// Change the font size of the btn to 41rem
...
allHrsArray.forEach(hr => hr.style.border = '1px solid tomato');
